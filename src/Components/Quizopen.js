...
const Quizopen = () => {
    ...
    }, [timeLeft, quizSubmitted, calculateScore]);
    ...
    return (
        <div className='container p-3 main'>
            <h3 style={{ textAlign: "center" }}>{quiz.title}</h3><br />
            ...
            <div className='container next mt-5'>
                ...
                <div className='d-flex justify-content-between'>
                    ...
                    {currentQuestionIndex < quiz.questions.length - 1 ? (
                        <button className='btn btn-outline-primary' onClick={handleNextQuestion}>Next</button>
                    ) : (
                        <button className='btn btn-success' onClick={handleFinishTest}>Submit</button>
                    )}
                </div>
            </div>
        </div>
